    ...
    def train(self, epochs):
        ...
        for epoch in iterator:
            ...
            for nb, tensors in enumerate(train_dataloader):
                ...
                self._model._auto_model.zero_grad()
                loss.backward()
                if self._max_grad_norm > 0.:
                    torch.nn.utils.clip_grad_norm_(parameters=self._model._auto_model.parameters(), 
            ...
            if self._val_dataset is not None:
                ...
                if self._keep_best_model and (dec_metric < best_dec_metric):
                    best_model = copy.deepcopy(self._model._auto_model.state_dict())
            ...
            if self._restore_bm_on_lr_change and get_lr() < prev_lr:
                ...
                self._model._auto_model.load_state_dict(best_model)
